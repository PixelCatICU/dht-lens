    ...
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            dht: DhtConfig {
                ...
                get_peers_probe_depth: env_usize("DHT_GET_PEERS_PROBE_DEPTH", 2).clamp(0, 8) as u8,
                ...
                crawl_response_nodes: env_usize("DHT_CRAWL_RESPONSE_NODES", 8).clamp(0, 16),
            ...
            pipeline: PipelineConfig {
                ...
                peer_collect_window: Duration::from_millis(env_u64(
                    "PEER_COLLECT_WINDOW_MS",
                    2_000,
                )),
